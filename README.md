...
- Шаги к успеху:
  ...
  - Создать базу данных:
    - Рецепт
    - Ингридиент
    - какие ещё модели нужно создать, чтобы проект полноценно работал?
...
- НЕ реализовано:
  ...
  для модели рецептов на странице рецепта вывести общее число добавлений этого рецепта в избранное
