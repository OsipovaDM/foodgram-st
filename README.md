...
- НЕ реализовано:
  ...
  - раздать права на методы
  - структура ответа inredients list, recipe list
  ...
  - Пароль пользователя не сохраняется должным образом!!!!! +
  - Валидация уникального значения не создается в сериализаторе автоматически у пользователя +
